## Web Create  
----------
+ Web Tag에서 사용한 내용을 이용하여 웹을 제작합니다
+ 1.html을 제외하고
+ 2.html
+ 3.html
+ index.html파일을 만들어 줍니다
...
<body>
  ...
  <h2>HTML</h2>
  <p><a href="https://terms.naver.com/entry.nhn?docId=1168097&cid=40942&categoryId=32838"
  target="_blank" title="html5
  cpeicification">인터넷 서비스의 하나인 월드 와이드 웹을 통해 볼 수 있는 문서를 만들 때 사용하는 웹 언어의 한 종류이다.</a>   
  특히 하이퍼텍스트를 작성하기 위해 개발되었으며, <strong>인터넷에서 웹을 통해 접근되는 <u>대부분의 웹 페이지들은</u> HTML로 작성된다.<strong>
...
```    
> 이렇게 작성을 하였을 때  
> 평소에 우리가 바라보는 웹사이를 제작할 수 있습니다  
> 먼저 만들어 주었던 태그 파일들을 클릭하면  
> 각각의 파일들로 이동할 수 있도록 됩니다  
